...
const API_KEY = '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';
...
async function generateResponse() {
    ...
    try {
        ...
        // Using Cypher Alpha (free) model from OpenRouter
        const modelEndpoint = 'openrouter/cypher-alpha:free';
        ...
        const response = await fetch(
            `https://openrouter.ai/api/v1/chat/completions`,
            {
                ...
                headers: { 
                    ...
                    'HTTP-Referer': window.location.href, // Optional, as in Python example
                    'X-Title': 'LAURIXY AI' // Optional, as in Python example
                },
                body: JSON.stringify({
                    model: modelEndpoint,
                    messages: messages,
