...
async function generateResponse() {
    ...
    try {
        ...
        // Using DeepSeek model from OpenRouter
        const modelEndpoint = 'deepseek/deepseek-chat-v3-0324:free';

        console.log(`Using model: ${modelEndpoint}`);
        console.log('Context length:', messages.length);
        ...
        // Check if the user asked about who created/developed Wonder AI
        ...
        const creatorQuestions = [
            ...
            "who made wonder ai", "who created wonder ai", "who developed wonder ai",
            "who is the creator of wonder ai", "who is the developer of wonder ai",
            "who is the owner of wonder ai", "who owns wonder ai"
        ];
        ...
        if (isAskingAboutCreator) {
            enhancedResponse = `I was developed by Sheikh Haris. He enhanced my capabilities to create this Wonder AI application. ${enhancedResponse}`;
        }
